...
$job = [
    [
        ...
        "start" => "Июль 2021",
        "end" => "Май 2022",
        "description" => "Развитие торговых точек в вверенных регионах - взаимодействие с партнерами, контроль обучения персонала, развитие продаж",
    ],
    [
        "name" => "Директор офиса продаж",
        "start" => "Сентябрь 2018",
        "end" => "Июнь 2021",
        "description" => "Контроль продаж, обучение и адаптация персонала, наставничество",
    ],
    [
        "name" => "Менеджер офиса продаж",
        "start" => "Ноябрь 2017",
        "end" => "Август 2018",
        "description" => "Продажи и обслуживание, обучение и адаптация персонала, наставничество",
    ],
];
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
                ...
                <?php echo $job[0]["start"]?> - <?php echo $job[$i]["end"]?>
                <class="w3-tag w3-teal w3-round"></h6>
